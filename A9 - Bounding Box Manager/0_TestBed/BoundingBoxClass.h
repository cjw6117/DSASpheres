...
public:
	...
	*/
	void AddOBBToRenderList(matrix4 a_mModelToWorld, vector3 a_vColor, bool a_bRenderCentroid = false);

	void AddAABBToRenderList(vector3 a_vColor, bool a_bRenderCentroid = false);
